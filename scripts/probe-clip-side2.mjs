...
await sleep(100);
await sleep(2500);
await page.keyboard.press("Home"); await sleep(300); console.log("z valuenow:", await zSlider.getAttribute("aria-valuenow"));
const D = await grab("e-clip-z02");
console.log("E (z=0.02):", D, "ratio D/A2:", (D / A2).toFixed(3));
await browser.close();
