...
must(LIB.includes("mapInventory: { jobId: string; jobName: string; mainName: string; volumeCount: number; peak: string | null; peakPct: number | null; shapeR?: number | null; weakest?: { label: string; r: number; from: number } | null }[] | null;"), "X1 the inventory rides buildSessionReport's contract (typed, nullable while pending; peak + 1-decimal number — t214 + t215; t221's shapeR and t222's weakest optional-nullable — the grid never guesses)");
