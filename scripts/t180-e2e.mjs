...
try {
  ...
  must((await roster()).length === 23, "B3 the rejected batch landed nothing (roster 23)");
  ...
  must((await roster()).length === 23, "B6 diamond cleanup restores the roster");
  ...
  must((await roster()).length === 23, "B11 edge-test cleanup restores the roster");
  ...
  must((await roster()).length === 23, "B20 shelf-test cleanup restores the roster");
