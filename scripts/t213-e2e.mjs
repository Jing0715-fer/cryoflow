...
must(DLG.includes('const OWNER_HEAD = ["Job", "Main map", "Volumes", "Peak", "Δ winner"];'), "X2 the door key is the inventory table's exact head quintet (t214's Peak column joined it; t215's Δ winner joins too — the key grew by design this time)");
